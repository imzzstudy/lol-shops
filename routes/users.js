...
router.get('/join', function (req, res, next) {
    if(req.session.user){ 
        res.render('join', {session:req.session.user});
      }else{
...
router.post('/login', function (req, res, next) {
    ...
    Account.findOne({id: req.body.id,password:req.body.password }, function (err, exists) {
...
router.post('/comment' , function (req, res) {
    ...
    Posts.update({_id:id}, { $push: { comments : comment}},function(err, result){
        res.redirect('/users/post/'+id);
    });
});
